(function () {
    ...
    function generateSampleData() {
        ...
        // group.
        var sampleItems = [
            { group: sampleGroups[0], title: "Toolbar", subtitle: "Item Subtitle: 1", description: itemDescription, content: itemContent, backgroundImage: "/images/toolbar_icon.png" },
            { key: "openDocs", group: sampleGroups[0], title: "Open Documents", subtitle: "Item Subtitle: 2", description: itemDescription, content: itemContent, backgroundImage: "/images/document_icon.png" },
            { group: sampleGroups[0], title: "Breakpoints", subtitle: "Item Subtitle: 3", description: itemDescription, content: itemContent, backgroundImage: "/images/breakpoint_icon.png" },
            { group: sampleGroups[0], title: "Output", subtitle: "Item Subtitle: 4", description: itemDescription, content: itemContent, backgroundImage: "/images/output_icon.png" },
            { group: sampleGroups[0], title: "Command", subtitle: "Item Subtitle: 5", description: itemDescription, content: itemContent, backgroundImage: "/images/command_icon.png" },
            { group: sampleGroups[0], title: "Task List", subtitle: "Item Subtitle: 5", description: itemDescription, content: itemContent, backgroundImage: "/images/task_icon.png" },
            { group: sampleGroups[0], title: "Error List", subtitle: "Item Subtitle: 5", description: itemDescription, content: itemContent, backgroundImage: "/images/error_icon.png" },
